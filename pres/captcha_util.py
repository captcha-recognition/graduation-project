...
DEFAULT_FONTS = [os.path.join(DATA_DIR,tff) for tff in os.listdir(DATA_DIR)]
...
class ImageCaptcha(_Captcha):
    ...
    def __init__(self, width=160, height=60, fonts=None, font_sizes=None):
        ...
        self._height = height
        self._fonts = fonts or DEFAULT_FONTS
        self._font_sizes = font_sizes or (42, 50, 30)
        self._truefonts = []
    ...
    def create_captcha_image(self, chars, color, background):
        ...
        def _draw_character(c):
            ...
            font.size = (self._font_sizes[0],
                         self._font_sizes[1],
                         self._font_sizes[2]-5,self._font_sizes[2]+5)
